...

  {
    ...
    for (var entry : List.of(
      // Pair.of(Meters.of(1), RPM.of((1000))),
                            Pair.of(Meters.of(2), RPM.of(-1800)),
                            Pair.of(Meters.of(2.5), RPM.of(-1935)),
                            Pair.of(Meters.of(3), RPM.of(-2050)),
                            Pair.of(Meters.of(3.5), RPM.of(-2190)),
                            // Pair.of(Meters.of(3.5), RPM.of(2050),
                            Pair.of(Meters.of(4), RPM.of(-2320)),
                            Pair.of(Meters.of(5.2048), RPM.of(-2556.918)),
                            Pair.of(Meters.of(6), RPM.of(-2700))
