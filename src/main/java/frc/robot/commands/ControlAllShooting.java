...

  {
    ...
    for (var entry : List.of(
      // Pair.of(Meters.of(1), RPM.of((1000))),
                            Pair.of(Meters.of(2), RPM.of(-1900)),
                            Pair.of(Meters.of(2.5), RPM.of(-2035)),
                            Pair.of(Meters.of(3), RPM.of(-2150)),
                            Pair.of(Meters.of(3.5), RPM.of(-2290)),
                            // Pair.of(Meters.of(3.5), RPM.of(2050),
                            Pair.of(Meters.of(4), RPM.of(-2420)),
                            Pair.of(Meters.of(5.2048), RPM.of(-2656.918)),
