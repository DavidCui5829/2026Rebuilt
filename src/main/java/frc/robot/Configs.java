...
public final class Configs 
{
        ...
        public static final class KickerSubsystem {
                ...
                public static final SparkFlexConfig kickerRightMotorConfig = new SparkFlexConfig();
                        ...
                        static {
                                kickerLeftMotorConfig.idleMode(IdleMode.kCoast).smartCurrentLimit(80).voltageCompensation(12);
                                kickerRightMotorConfig.idleMode(IdleMode.kCoast).smartCurrentLimit(80).voltageCompensation(12).follow(13,true);
        ...
        public static final class HopperSubsystem {
            ...
            public static final SparkFlexConfig TwindexerLeftControllerConfig = new SparkFlexConfig();
                ...
                static {
                        ...
                        TwindexerRightControllerConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(80).voltageCompensation(12).follow(15, true);
                        TwindexerLeftControllerConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(80).voltageCompensation(12);
