...
public static final double LOOKAHEAD_MAX_SEC   = 0.5;
  ...
  public static class PushoutConstants {
    ...
    public static final double PUSHOUT_RETRACTED_POS = 9.386;
    public static final double PUSHOUT_EXTENDED_POS = 30.4; // TUNE THIS!!!

    public static final double PUSHOUT_RETRACTED_AGITATE_POS = 9.386; // encoder rotations
